...
CREATE TABLE `hei_admin` (
  ...
  `is_del` int(11) DEFAULT '0' COMMENT '是否删除 1删除',
  PRIMARY KEY (`id`),
...
INSERT INTO `hei_admin` VALUES (10,'admin1','$2y$10$Nn0mF6OJG/NwyB8u52VuIOI4wq5ZJlXXIStkJL1fznAalJDuOnLDe','192.168.184.1',1477862347,0,1477862347,1477865650,0,0,0),(13,'madison','$2y$10$sc9sgRHTbhqwA.HrgGFxPu9aQU8KB0TXGTHVjSw.F8/SlNkdr65j.','192.168.184.1',1477864192,0,1477864192,0,0,0,0);
...
CREATE TABLE `hei_admin_role` (
  ...
  `update_time` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `status` tinyint(8) NOT NULL DEFAULT '0' COMMENT '0 正常 1 禁用',
  `is_del` tinyint(4) DEFAULT '0' COMMENT '1删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='后台管理员角色关联表-小黑科技';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hei_admin_role` VALUES (1,10,2,0,0,0,0,0,0),(2,13,2,0,0,0,0,0,0),(3,10,2,0,0,0,0,0,0),(4,13,2,0,0,0,0,0,0),(5,10,2,0,0,0,0,0,0),(6,13,2,0,0,0,0,0,0);
...
CREATE TABLE `hei_auth` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='后台权限表-小黑科技';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-09 17:09:06
